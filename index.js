...
app.post('/whatsapp', async (req, res) => {
                    ...
                    //     break;
                        ...
                        case payload === 'Minimum 40%' || payload === 'Minimum 90%':
                            ...
                            case payload === '1,25,000' || payload === '1,75,000' || payload === 'No income limit':
                                ...
                                case payload === '0-6' || payload === '6-18' || payload === '18-24':
                                    // Extract gender from the message if available
                                    ...
                                    try {
                                        ...
                                        if (schemesData.length > 0) {
                                            let responseMessage = `Schemes for ${payload} and ${genderPayload}:\n\n`;
                                            ...
                                            const responseTemplate = {
                                                ...
                                                type: 'text',
                                                text: {
                                                    body: `No schemes found for the selected age group (${payload}) and gender (${genderPayload}).`,
                                                },
                                                language: {
                                                    code: 'en_US',
                                                },
    ...
    //                 type: 'text',
    //                 text: {
    //                     body: `No schemes found for the selected gender (${payload}).`,
    //                 },
    //                 language: {
    //                     code: 'en_US',
    //                 },
